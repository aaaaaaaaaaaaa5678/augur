...
docker run --rm --env NETWORK_ID="${NETWORK_ID}" --env NORMAL_TIME="${NORMAL_TIME}" --env PERIOD_TIME=5 -p 8545:8545 -p 8546:8546 --name pop-geth-deploy --detach augurproject/dev-node-geth:latest
